...
//            http.headers().cacheControl().disable();
            http.authorizeRequests()
                    ...
                    // 合同
                    .antMatchers("/controller/contract/**").permitAll()
                    // 产品
                    .antMatchers("/controller/product/**").permitAll()
                    // 月历
                    .antMatchers("/controller/calendar/**").permitAll()
                    // 收入分析表
                    .antMatchers("/controller/cwIncome/**").permitAll()
                    // 关于流程
                    .antMatchers("/controller/workflow/**").permitAll()
                    //2020--08-31-晶奇日报功能
                    .antMatchers("/controller/dailypaper/**").permitAll()
...
//                    .antMatchers("/api/app/query/**").permitAll()
                    // 用于测试的controller
//                    .antMatchers("/controller/testController/**").permitAll()
//                    .antMatchers("/api/runtime/workflow/get_instance_baseinfo").permitAll()
//                    .antMatchers("/api/runtime/workflow/**").permitAll()
